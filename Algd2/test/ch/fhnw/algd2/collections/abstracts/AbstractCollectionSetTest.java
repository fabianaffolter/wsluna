 ...
 * @param <E>
 */
public abstract class AbstractCollectionSetTest {
	private static final int DEFAULT_SIZE = 10;

	protected MyAbstractCollectionSet<Integer> bag;
	...
	protected abstract MyAbstractCollectionSet<Integer> createIntegerCollection(
			int size);
