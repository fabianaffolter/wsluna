...
public class main_AVL {
	...
	// operation modes
	static final boolean MASS_OPERATION = true; // mass tests or detail tests
												// switch
	...
	static int[] ki = { 16, 14, 0, 1, 17, 5, 9, 18, 8, 6, 10, 13, 4, 3, 2, 19,
			12, 15, 7, 11 };
	static int[] kd = { 10, 17, 18, 13, 6, 16, 0, 1, 14, 19, 8, 7, 5, 3, 15, 9,
			2, 4, 11, 12 };
	...
	public static void main(String[] blah) {
		...
		if (MASS_OPERATION) {
			...
			System.out.println(" > Initializer : balanced = "
					+ t.checkBalanceFactors());
			System.out
					.println("----------------------------------------------------");
			System.out
					.println("----------------------------------------------------");
		...
		if (MASS_OPERATION) {
			...
			for (int i = 0; i < kd.length; ++i) {
				...
				System.out.println(" > Balance "
						+ (t.checkBalanceFactors() ? "ok" : "corrupted"));
				System.out
						.println("----------------------------------------------------");
			}
		}
	...
	public static void massInserterTest() {
		...
		System.out.println();
		System.out.println("Successful Inserts :"
				+ String.format("%5d", successful));
		System.out.println("Rejected Inserts   :"
				+ String.format("%5d", rejected));
		System.out.println("Balance is OK      :"
				+ String.format("%5d", bal_OK));
		System.out.println("Balance failed     :"
				+ String.format("%5d", bal_Fail));
	}
	...
	public static void massDeleterTest() {
		...
		System.out.println();
		System.out.println("Successful Deletes :"
				+ String.format("%5d", successful));
		System.out.println("Rejected Deletes   :"
				+ String.format("%5d", rejected));
		System.out.println("Balance is OK      :"
				+ String.format("%5d", bal_OK));
		System.out.println("Balance failed     :"
