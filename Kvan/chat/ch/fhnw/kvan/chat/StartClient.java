...
/**
 * Class StartClient is used to start the Client side of the chat application.
 * As a runtime parameter the name of the class which implements the
 * <code>Client</code> class has to be specified. This class is then loaded and
 * its main() method invoked, using corresponding arguments.
 * 
 * E.g. start the application with one of the following commands, which are
 * defined in the Clients.txt file.
 * 
 * <pre>
...
public class StartClient {
	...
	public static void main(String args[]) {
		...
		try {
			...
			logger.error("class " + args[0] + " does not have such method");
			System.exit(1);
			...
			logger.error("class " + args[0] + " could not be instantiated");
			System.exit(1);
